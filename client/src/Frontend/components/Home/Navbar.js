...
const NavBar = () => {
  ...
  return (
    <Navbar expand="lg" className="navbar px-7 py-3" variant="dark" expanded={expanded}>
      <Container fluid>
        <Navbar.Brand as={Link} to="/" className="navbar-brand">
          <img
             src="https://res.cloudinary.com/dyywbqzfk/image/upload/v1739632725/ywb1yrxjecgoxdhoarqy.png"
            alt="Company Logo"
            style={{ width: "100px", height: "75px", top: 0 }}
          />
        </Navbar.Brand>
        <Navbar.Toggle
